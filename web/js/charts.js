...
var containers = document.getElementById('mainContainer');
var resizeWorldMapContainer = function () {
    worldMapContainer.style.width = containers.clientWidth + 'px';
    worldMapContainer.style.height = containers.clientHeight + 'px';
};
//设置容器高宽
